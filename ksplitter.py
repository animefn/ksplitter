...
if __name__ == "__main__":
    ...
    groupSelector.add_argument('-syl','--syllables',action='store_const',dest='mode',const='syl', help='makes splitting by romaji syl (default) [only pick one of the three char,syl,word]')
    groupSelector.add_argument('-char','--characters',action='store_const',dest='mode',const='char', help='makes splitting after each character [only pick one of the three char,syl,word]')
    groupSelector.add_argument('-word','--word',action='store_const',dest='mode',const='word' ,help='makes splitting after each word [only pick one of the three char,syl,word]')
